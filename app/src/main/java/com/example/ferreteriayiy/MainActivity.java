...
public class MainActivity extends AppCompatActivity {
    ...
    private String url = "https://ferreteriayiy.herokuapp" +
            ".com/api_clientes?user_hash=12345&action=get";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_clientes_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(MainActivity.this, Activity_View.class);
    ...
    public void activityInsertOnClick(View view){
        Intent i = new Intent(MainActivity.this,Activity_insert.class);
        startActivity(i);
    }
